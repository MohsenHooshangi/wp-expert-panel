    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                <div class="dashboard_stats_wrap_content"><h4 class="text-success">10</h4> <span>در حال بررسی</span></div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                <div class="dashboard_stats_wrap_content"><h4 class="text-warning">42</h4> <span>تکمیل شده</span></div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                <div class="dashboard_stats_wrap_content"><h4 class="text-danger">70h</h4> <span>مدت کل دوره</span></div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
            <div class="dashboard_stats_wrap">
                <div class="dashboard_stats_wrap_content"><h4 class="text-info">22</h4> <span>تدریس آنلاین</span></div>
                <div class="dashboard_stats_wrap-icon"><i class="ti-user"></i></div>
            </div>
        </div>
                  ...
                  <?php echo $post; ?>
                    <div class="learnup-list">
                        ...
                        <div class="learnup-list-caption">
                            ...
                            <div class="learnup-info mt-2"><span class="ml-3">2ساعت 22دقیقه</span><span>4,52,236 شرکت کننده</span></div>
                        </div>
                    </div>
